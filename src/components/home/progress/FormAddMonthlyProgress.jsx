...
import { DatesProvider, MonthPickerInput, YearPickerInput } from '@mantine/dates';
...
export default function FormAddMonthlyProgress() {
    const [value, setValue] = useState(null);

    return (
        <>
            <MantineProvider withGlobalClasses>
            <h1 className='px-7 py-4 border-b-2 border-slate-700 bg-slate-300 text-base md:text-xl lg:text-2xl font-semibold'>Formulir Pencapaian <span className='underline underline-offset-2 decoration-4 decoration-sky-400'>Bulanan</span></h1>
            <form className='flex flex-col w-full py-5 px-10'>
                <div className='grid grid-cols-1 xl:grid-cols-2 md:gap-4 w-full xl:mb-4'>
                    <div className=''>
                    ...
                    <div className='mt-4 xl:mt-0 lg:mt-0'>
                        <label htmlFor='date' className="block mb-2 font-semibold text-sm text-gray-500">Bulan/Tahun <span>*</span></label>
                        <DatesProvider settings={{ locale: 'id' }}>
                            <MonthPickerInput placeholder="Bulan - Tahun" size='sm' value={value} onChange={setValue} radius='md' className='w-full' />
                        </DatesProvider>
                    </div>
                </div>
                ...
                <div className='mt-4 xl:mt-0'>
                    <div>
                        ...
                        <input id='note' type='text' className='p-2.5 rounded-lg bg-slate-50 border-2 border-gray-500 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full mb-6 placeholder:text-slate-300'/>
                    </div>
                </div>
